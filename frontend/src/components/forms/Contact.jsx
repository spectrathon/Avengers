...
function Contact({display}) {
  ...
  return (
    <>
    <SignedIn>
    <div style={{display:display}} className={`contact-inner flex flex-end justify-center items-center ${gradientStyles} shadow-2xl rounded-md w-64 h-96 absolute mt-4 ml-64`}>
